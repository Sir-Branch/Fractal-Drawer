...
${OBJECTDIR}/draw_fractals.o: draw_fractals.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/draw_fractals.o draw_fractals.c

${OBJECTDIR}/input_manage_verification.o: input_manage_verification.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/input_manage_verification.o input_manage_verification.c
...
${OBJECTDIR}/main_parsing_eda.o: main_parsing_eda.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_parsing_eda.o main_parsing_eda.c
